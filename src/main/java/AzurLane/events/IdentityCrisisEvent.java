...
import static AzurLane.AzurLane.makeEventPath;

public class IdentityCrisisEvent extends AbstractImageEvent {


    public static final String ID = AzurLane.makeID("IdentityCrisisEvent");
            ...
            case 0:
                switch (i) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        imageEventText.loadImage("AzurLaneResources/images/events/IdentityCrisisEvent2.png");
